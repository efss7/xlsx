    ...
    fretes: [
      {
        ...
        direcionamentoMotoristaSelecionado: null,
        pendencia: {
          mensagens: ["Motorista possui senha de acesso", "Requer ação manual"],
...
document
  ...
  .addEventListener("click", gerarPlanilha);
...
// const colunasAlinharDireita = [5, 6, 7];
// const alinhamentoDireitaStyle = { alignment: { vertical: 'right' } };
// for (let row = 0; row < conteudoPlanilha.length; row++) {
//   colunasAlinharDireita.forEach((colIndex) => {
//     const cellRef = XLSX.utils.encode_cell({ r: row, c: colIndex });
//     const cell = worksheet[cellRef] || { s: {} };
//     cell.s = alinhamentoDireitaStyle;
